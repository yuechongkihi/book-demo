    ...
    <div class="header">
      ...
      <div id="menu_index">
        ...
        >
          ...
          <el-menu-item index="2" class="header-title">训练营</el-menu-item>
          <el-menu-item index="3" class="header-title">大课表</el-menu-item>
          <el-menu-item index="4" class="header-title">关于我们</el-menu-item>
          <el-menu-item index="5" class="header-title">论坛点评</el-menu-item>
        </el-menu>
      ...
      <div
        v-if="seen"
        style="float: right; display: flex;align-items: center; height: 100%;"
      >
        <el-button
          type="text"
          ...
          >登录</el-button
        >
        <el-button type="primary" class="header-title" @click="register" round
          >注册</el-button
        >
      </div>
    </div>
